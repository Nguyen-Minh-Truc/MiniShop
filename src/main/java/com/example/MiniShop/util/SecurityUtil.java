...
public class SecurityUtil {
  ...
  public SecurityUtil(JwtEncoder jwtEncoder) { this.jwtEncoder = jwtEncoder; }

  public static final MacAlgorithm JWT_ALGORITHM = MacAlgorithm.HS512;

  @Value("${mt.jwt.base64-secret}") private String jwtKey;

  @Value("${mt.jwt.access-token-validity-in-seconds}")
